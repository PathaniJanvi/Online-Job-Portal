<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Dashbord.aspx.cs" Inherits="OnlineJobPortal.Admin.Dashbord" %>
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <% Response.Write(Session["Register"]); %>
                                        <!-- User count -->
                                    </h2>
                                </div>
                            </div>
                    ...
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <% Response.Write(Session["AddNewJob"]); %>
                    ...
                    <div class="card l-bg-green-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <% Response.Write(Session["ApplyJob"]); %>
